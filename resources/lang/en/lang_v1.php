...
return [
   ...
   'payment_paid_notification' => 'Payment Paid Notification',
    ...
    'stock_log' => 'Stock Log',
    'stock_log_help' => 'Compare system stock with real (sellable) stock per product',
    'view_stock_log' => 'View Stock Log',
    'stock_mismatch' => 'Mismatch',
    'stock_match' => 'Match',
    'only_mismatch' => 'Show only mismatches',
    'system_stock' => 'System Stock',
    'real_stock' => 'Real Stock (Sellable)',
    'stock_difference' => 'Difference',
    'orphan_mapping' => 'Orphan Mapping',
    'orphan_mapping_help' => 'There are purchase-sell mapping rows whose sell line has been deleted. This makes the real stock lower than the system stock and checkout can fail with a mismatch error. Fix it by deleting the orphan mapping rows in the database and reducing quantity_sold on the related purchase line.',
    'stock_comparison' => 'Stock Comparison',
    'purchase_line_breakdown' => 'Purchase Line Breakdown (FIFO/LIFO)',
    'purchase_line_id' => 'Purchase Line ID',
    'sell_line_id' => 'Sell Line ID',
    'quantity_sold' => 'Qty Sold',
    'quantity_adjusted' => 'Qty Adjusted',
    'quantity_returned' => 'Qty Returned',
    'no_purchase_lines_found' => 'No purchase lines found',
];
